...
def send_mail(mail_add, title, message):
	driver = webdriver.Firefox(executable_path="/home/db1/Documents/Softi_project/geckodriver")
	url = 'https://www.google.com/accounts/Login?hl=ja&continue=http://www.google.co.jp/'
	driver.get(url)
	#>>>>gmail username and password
	driver.find_element_by_id("identifierId").send_keys("sainideepak119@gmail.com")
	driver.find_element_by_id("identifierNext").click()
	time.sleep(3)
	#>>>>
	driver.find_element_by_xpath("//input[@type='password']").send_keys("Sai500081")
	...
	driver.find_element_by_xpath("//div[@class='Am Al editable LW-avf']").send_keys(message)
